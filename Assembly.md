...
Use a hot-air rework station to solder the **Honeywell MPRLS0300YG** pressure sensor to the board. For ease of soldering, also heat the assembled board with a [miniture hot plate from Adafruit](https://www.adafruit.com/product/4948) or [from AliExpress](https://www.aliexpress.us/item/3256806194378309.html)
...
6. Set the hotplate to approximately **200 °C**.
7. Set the hot-air station to approximately **350 °C**.
8. Let the temperature of the hotplate increase.
9. Using gentle airflow, heat the pressure sensor evenly from above until the solder reflows and the sensor settles into place.
10. Do **not** push the sensor while the solder is molten.
11. Remove the hot air and allow the board to cool before touching or moving the sensor.
12. Clean the flux residue using isopropyl alcohol.
...
- [Adafruit ESP32-S3 Pinout](https://learn.adafruit.com/adafruit-esp32-s3-feather/pinouts)
