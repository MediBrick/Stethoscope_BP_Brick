...
Refer to [Microcontroller_Software.md](https://github.com/walle637/Stethoscope_BP_Brick/edit/patch-2/Microcontroller%20Software.md) for installation and usage instructions of the microcontroller software.
